                ...
                vec![
                    BasicBlockData::with(
                        ...
                        vec![
                            ...
                            Instruction::Branch(BranchOpcode::Blt, Value(2), BasicBlock(6)),
                        ],
                        ControlFlowEdge::IfStmt(BasicBlock(1), Some(BasicBlock(6)), BasicBlock(5)),
                        Some(BasicBlock(7)),
                        hashmap! { "a".to_string() => Value(0) },
                    ),
                    BasicBlockData::with(
                        // inner condition block
                        vec![
                            Instruction::StoredBinaryOp(
                                StoredBinaryOpcode::Cmp,
                                Value(0),
                            ...
                            Instruction::Branch(BranchOpcode::Bne, Value(3), BasicBlock(4)),
                        ],
                        ControlFlowEdge::IfStmt(BasicBlock(2), Some(BasicBlock(4)), BasicBlock(3)),
                        Some(BasicBlock(0)),
                        hashmap! { "a".to_string() => Value(0) },
                    ),
                    BasicBlockData::with(
                    ...
                    BasicBlockData::with(
                        ...
                        vec![
                            Instruction::Nop,
                            Instruction::UnconditionalBranch(BasicBlock(5)),
                        ],
                        ControlFlowEdge::Branch(BasicBlock(5)),
                        Some(BasicBlock(1)),
                        hashmap! { "a".to_string() => Value(0) },
                    ),
                    BasicBlockData::with(
                    ...
                    BasicBlockData::with(
                        ...
                        ControlFlowEdge::Fallthrough(BasicBlock(5)),
                        Some(BasicBlock(0)),
                        hashmap! { "a".to_string() => Value(0) },
                    ),
                    BasicBlockData::with(
                ...
                vec![
                    ...
                    BasicBlockData::with(
                        ...
                        vec![
                            ...
                            Instruction::Branch(BranchOpcode::Ble, Value(3), BasicBlock(6)),
                        ],
                        ControlFlowEdge::IfStmt(BasicBlock(4), Some(BasicBlock(6)), BasicBlock(5)),
                        Some(BasicBlock(0)),
                        hashmap! { "a".to_string() => Value(0) },
                    ),
                    BasicBlockData::with(
